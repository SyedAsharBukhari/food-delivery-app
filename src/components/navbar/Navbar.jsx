  ...
  return (
    <div>
      ...
      <section className="py-2 bg-[#E01B6F] text-white text-right px-10">
        <p className="text-sm"><span className="mx-3 font-semibold">Address:</span>Karachi, Pakistan<span className="mx-3 font-semibold">Contact
          No:</span>123456789</p>
      </section>

      <div className="flex flex-wrap items-center justify-between gap-4 px-10 py-3 bg-white min-h-[65px]">
        <Link to="/" className='text-2xl md:text-4xl font-bold text-[#e01b6f] mb-4'>Foodify
        </Link>
        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
              <Link to='/'
                className="hover:text-[#E01B6F] text-[#E01B6F] block font-medium text-[15px]">Home</Link>
            </li>
            <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><Link to='/about'
              className="hover:text-[#E01B6F] text-slate-900 block font-medium text-[15px]">About</Link>
            </li>
            <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><Link to='/contact'
              className="hover:text-[#E01B6F] text-slate-900 block font-medium text-[15px]">Contact</Link>
            </li>
          </ul>
        </div>
